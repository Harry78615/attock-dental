      ...
      return '<div class="offer-card">' +
        '<div class="offer-card-top">' +
          ...
          '<div class="offer-pricing">' +
            (offer.originalPrice ? '<span class="offer-price-original">' + offer.originalPrice + '</span>' : '') +
            '<span class="offer-price-new' + (offer.offerPrice === 'FREE' ? ' free' : '') + '">' + offer.offerPrice + '</span>' +
          '</div>' +
